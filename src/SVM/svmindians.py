...
if best == True:
    ...
    svclassifier = SVC(kernel='rbf',C=10, coef0=0, decision_function_shape= 'ovo', gamma= 1e-05, shrinking= True, tol=0.0001, probability=True)  
    ...
    'shrinking':(True,False), 'tol':(0.0001,0.0005,0.001,0.005,0.01,0.1),'decision_function_shape':('ovo','ovr')}#
...
##best params:{'C': 10, 'coef0': 0, 'decision_function_shape': 'ovo', 'gamma': 1e-05, 'kernel': 'rbf', 'shrinking': True, 'tol': 0.0001} TR/TS:78%/82%---MSE 0.23127,0.17532
